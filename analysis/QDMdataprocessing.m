...
%use 2.42 �m for QDM1 4x4 binning
%use 4.68 �m for the 10x objective with 4x4 binning
%use 2.34 �m for the 20x objective with 4x4 binning
%assumed 100 mm tube lens

xstep=input('Pixel size [4.70 �m]: ')*1e-6;
if isempty(xstep)
    xstep=4.70e-6;
end

%ask user for the NV layer-sample distance
h=input('NV-sample distance [5 �m]: ');
if isempty(h)
    h=5e-6;
end
