function results = dipole_fit_series(nFolders, kwargs, filter)
%[results] = dipole_fit_series(nFolders; 'checkPlot', 'fileName', 'imageFolder', 'nROI', 'outputTrue', 'refIdx', 'save', 'transFormFile', 'upCont')
