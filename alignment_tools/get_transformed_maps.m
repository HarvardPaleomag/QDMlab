...
%[transformedData, nFiles] = get_transformed_maps(nFolders; 'checkPlot', 'chi', 'fileName', 'fixedIdx', 'includeHotPixel', 'removeHotPixels', 'reverse', 'threshold', 'transFormFile', 'upCont', 'winSize')
