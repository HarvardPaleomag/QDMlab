...
%%
res = demag_behavior(folders, 'fileName', fname, 'bootStrapN', 1000, 'pixelShift', 3, 'filterProps', struct('threshold', 1.5), 'quadBgSub', 1);%, 'filterProps', struct('threshold', 5, 'chi', true, 'cutOff', 14))
%%
